...
const _logger = debug.extend("BlogSection");
...
export default class BlogSections extends Component {
  ...
  //new badge will show on the latest posted blogs (3 days).
        ...
        <Card className={clsx("mb-4", styles.blogGrid)}>
          ...
          >
            <div className="avatar-icon-wrapper avatar-icon-sm">
              <div className="avatar-icon border-1 border-white rounded">
          ...
          <div className="py-5">
            <Container>
              <Grid container spacing={4}>
                {this.state.blogs.filter(function (blog) { return blog.isPublished === true }).map(this.mappedBlog)}
              </Grid>
            </Container>
          </div>
          <Pagination
